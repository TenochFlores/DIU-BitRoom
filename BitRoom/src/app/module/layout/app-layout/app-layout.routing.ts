...
export const AppLayoutRoutes: Routes = [
    ...
    { path: 'audios', component: VideosComponent },
    { path: 'libros', component: VideosComponent },
    { path: 'juegos', component: VideosComponent },
    { path: 'sesion-de-estudio', component: SesionDeEstudioComponent },
    { path: 'comunidad', component: ComunidadComponent },
    { path: 'mis-sesiones', component: SesionDeEstudioComponent },
];